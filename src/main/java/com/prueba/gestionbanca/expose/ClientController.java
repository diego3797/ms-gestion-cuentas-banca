...
public class ClientController {
    ...
    public void deleteClient(
            @Parameter(name = "clientId", description = "Client id to delete", required = true, in = ParameterIn.PATH)
    ...
    public ResponseEntity<Mono<Client>> getClientById(
            @Parameter(name = "clientId", description = "ID of client to return", required = true, in = ParameterIn.PATH)
            @PathVariable("clientId") String clientId
    ) {
    ...
    public ResponseEntity<Mono<Client>> updClient(
            @Parameter(name = "ClientRequest", description = "Update a client in the bank", required = true)
